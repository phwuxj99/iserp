<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="InvoiceList.aspx.cs" Inherits="iserp.InvoiceList" %>
                                ...
                                <div class="DivTable">
                                    ...
                                    <div class="DivTableRow100">
                                        <div class="DivTable2ColHalf">
                                            ...
                                            <br />
                                            <asp:Label ID="Label4" runat="server" Text="发票日期: " Font-Bold="True" Font-Size="Small"></asp:Label>
                                        </div>
                                        <div class="DivTable2ColHalf">
                    ...
                    <div class="pageSegment">
                        <div class="DivTableRow">
                            <div class="DivTable2firstcolErp">
                                ...
                                <br />
                                <asp:Label ID="Label9" runat="server" Text="买者: " Font-Bold="True" Font-Size="Small"></asp:Label>
                            </div>
                        ...
                        <PageHeaderTemplate>
                            ...
                            <div class="DivTable">
                                <div class="DivTableRowLeft">
                                    ...
                                    <br />
                                    <asp:Label ID="Label1" runat="server" Text="Address:113-2631 Viking Way, Richmond, BC V6V 1N3"
                                        Font-Bold="True" Font-Size="10px">
                                    </asp:Label>
                                    <br />
                                    <asp:Label ID="Label2" runat="server" Text="Tel:604-821-0780  Fax:604-821-0784  Cell:778-389-0780"
                                        Font-Bold="True" Font-Size="10px">
                                    </asp:Label>
                                </div>
                            </div>
